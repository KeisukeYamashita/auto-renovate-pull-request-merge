# Auto Renovate Pull Request Merge
[![CI][CI]][CI-status]
[![GitHub Marketplace][MarketPlace]][MarketPlace-status]
[![Mergify Status][mergify-status]][mergify]
[![Renovate Badge][Renovate Icon]][Renovate]

A GitHub Action that merges a [Renovate](https://www.whitesourcesoftware.com/free-developer-tools/renovate) request automatically by the latest commit check status.
